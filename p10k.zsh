# Generated by Powerlevel10k configuration wizard on 2024-08-12 at 01:45 EDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%f'
      local      clean='%F{#cba6f7}'
      local   modified='%F{#cba6f7}'
      local  untracked='%F{#cba6f7}'
      local conflicted='%F{#cba6f7}'
    else
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}󰛐${VCS_STATUS_NUM_UNSTAGED}"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND="#a6d189"
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND="#89b4fa"
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND="#eebebe"
  ...
  typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='gcloud|gcs|gsutil'
   # Google cloud color.
  typeset -g POWERLEVEL9K_GCLOUD_FOREGROUND="#99d1db"
  ...
  [ -f "${HOME}/.zsh/local-prompt.sh" ] && source "${HOME}/.zsh/local-prompt.sh"
